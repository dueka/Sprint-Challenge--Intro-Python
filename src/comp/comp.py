...
c = [human.name for human in humans if human.name[0] == 'C' or human.name[0] ==
     'd' or human.name[0] == 'E' or human.name[0] == 'F' or human.name[0] == 'G']
print(c)
...
f = [(human.name, human.age)
     for human in humans if human.age > 27 & human.age < 32]
print(f)
